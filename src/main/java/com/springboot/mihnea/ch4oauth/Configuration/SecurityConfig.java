package com.springboot.mihnea.ch4oauth.Configuration;
...
public class SecurityConfig {
    ...
    public OAuth2AuthorizedClientManager clientManager(ClientRegistrationRepository clientRegRepo, OAuth2AuthorizedClientRepository authClientRepo) {
        ...
        DefaultOAuth2AuthorizedClientManager clientManager = new DefaultOAuth2AuthorizedClientManager(clientRegRepo, authClientRepo);
